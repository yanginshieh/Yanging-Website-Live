...
<div class="mainPage">
	<div class="headerHeight">
		<div class="headerLeft">
			<div>
				<a href="<?php echo get_option('home'); ?>"/><img class="header_logo" src="<?php echo get_option('header_logo'); ?>" height="80" width="80"/></a>
			</div>
		</div>
		<div class="headerRight">
			<p><strong><?php echo get_option( 'wp_theme_settings_title'); ?></strong></p>
			<p><a href="mailto:<?php echo get_option('user_email_address'); ?>" title="Email <?php echo get_option('user_email_address'); ?>"> <?php echo get_option('user_email_address'); ?> </a></p>
		</div>
	</div>
