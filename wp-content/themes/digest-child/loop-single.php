...
<div class="post-date" style="padding-top:0px"><?php the_time('F j, Y') ?> - <?php comments_number('No Comments', 'One Comment', '% Comments' ); ?></div>
				...
				<!-- #post-## -->
<div class="post-nav">
					<div class="post-nav-l"><?php next_post_link( __('Previous post<br/>%link', '%title <span class="meta-nav">' . '</span>' , 'digest')); ?></div>
					 <div class="post-nav-r"><?php previous_post_link(__('Next post<br/>%link', '<span class="meta-nav">' . '</span> %title', 'digest')); ?></div>
				</div><!-- /page links -->
